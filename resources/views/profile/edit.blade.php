        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="text-left pt-4 sm:pt-6 mb-4 sm:mb-6">
                <p class="text-xs sm:text-sm font-semibold uppercase tracking-widest flex items-center gap-2">
                    ...
                    <span class="text-[#254bfe] font-bold">Edit Profile</span>
                </p>
            </nav>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start relative">
                ...
                <div class="lg:sticky lg:top-6 w-full space-y-6 z-10">
                    ...
                    <div class="bg-[#F8F8F8] border-4 border-[#FC00BB] p-5 sm:p-6 shadow-[8px_8px_0px_0px_#2F3AFF] relative w-full flex flex-col items-center text-center"
                        ...
                        <div class="w-full flex flex-col items-center justify-center text-center">
                            ...
                            <div class="flex items-center justify-center gap-2">
                                <label for="profile_image" class="px-5 py-2 bg-[#2F3AFF] hover:bg-[#FC00BB] hover:text-[#D9FC28] text-white font-sans text-xs font-bold transition-all cursor-pointer inline-flex items-center justify-center">
                                    Choose File
                                </label>
                    ...
                    <div class="bg-[#F8F8F8] border-4 border-[#FC00BB] p-5 sm:p-6 shadow-[8px_8px_0px_0px_#2F3AFF] relative w-full flex flex-col items-center text-center"
                        ...
                        <div class="w-full flex flex-col items-center justify-center text-center">
                            ...
                            <div class="flex items-center justify-center gap-2">
                                <label for="cover_image" class="px-5 py-2 bg-[#2F3AFF] hover:bg-[#FC00BB] hover:text-[#D9FC28] text-white font-sans text-xs font-bold transition-all cursor-pointer inline-flex items-center justify-center">
                                    Choose File
                                </label>
                                <span x-text="fileName || 'No file chosen'" class="font-sans text-xs text-[#2F3AFF] font-medium"></span>
                            </div>
                ...
                <div class="w-full space-y-8">
                    ...
                    <form id="form-profile-update" method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="space-y-4">
                            <h2 class="font-display text-2xl sm:text-3xl text-[#2F3AFF] font-normal">Informasi Personal</h2>

                            <div>
                                <label for="name" class="block font-sans text-xs text-[#2F3AFF] font-bold tracking-wider mb-1">NAMA *</label>
                            ...
                            <div>
                                <label for="creator_type" class="block font-sans text-xs text-[#2F3AFF] font-bold tracking-wider mb-1">KATEGORI KREATOR</label>
                            ...
                            <div>
                                <label for="email" class="block font-sans text-xs text-[#2F3AFF] font-bold tracking-wider mb-1">EMAIL *</label>
                            ...
                            <div>
                                <label for="location" class="block font-sans text-xs text-[#2F3AFF] font-bold tracking-wider mb-1">LOKASI</label>
                            ...
                            <div>
                                <label for="bio" class="block font-sans text-xs text-[#2F3AFF] font-bold tracking-wider mb-1">DESKRIPSI / BIO</label>
                        ...
                        <div class="space-y-4">
                            <h2 class="font-display text-2xl text-[#2F3AFF] font-normal">Tautan</h2>

                            <div>
                                <label for="instagram" class="block font-sans text-xs text-[#2F3AFF] font-bold tracking-wider mb-1">INSTAGRAM</label>
                            ...
                            <div>
                                <label for="website" class="block font-sans text-xs text-[#2F3AFF] font-bold tracking-wider mb-1">WEBSITE</label>
                                <div class="relative flex items-center">
                        ...
                        <div class="pt-2">
                            <button type="submit" 
                                    class="w-full py-3 bg-[#FC00BB] hover:bg-[#2F3AFF] text-[#D9FC28] hover:text-white font-sans text-sm font-semibold tracking-wide transition-colors flex items-center justify-center gap-2 shadow-sm cursor-pointer">
                        ...
                        @if (session('status') === 'profile-updated')
                            <p x-data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 3000)" 
                               class="font-display text-xs text-[#2F3AFF] bg-[#D9FC28] px-3 py-1.5 border border-[#2F3AFF] text-center">
                    ...
                    <form method="post" action="{{ route('password.update') }}" class="space-y-4">
                        ...
                        <h2 class="font-display text-2xl text-[#2F3AFF] font-normal">Keamanan & Password</h2>

                        <div>
                            <label for="update_password_current_password" class="block font-sans text-xs text-[#2F3AFF] font-bold tracking-wider mb-1">PASSWORD SAAT INI</label>
                        ...
                        <div>
                            <label for="update_password_password" class="block font-sans text-xs text-[#2F3AFF] font-bold tracking-wider mb-1">PASSWORD BARU</label>
                        ...
                        <div>
                            <label for="update_password_password_confirmation" class="block font-sans text-xs text-[#2F3AFF] font-bold tracking-wider mb-1">KONFIRMASI PASSWORD BARU</label>
                        ...
                        <button type="submit" 
                                class="w-full py-2.5 bg-[#FC00BB] hover:bg-[#2F3AFF] text-[#D9FC28] hover:text-white font-sans text-xs font-semibold tracking-wide transition-colors shadow-sm cursor-pointer">
                            Update Password
                        </button>
                    </form>
                    ...
                    <div class="bg-red-50 border-2 border-red-500 p-5 rounded-tl-2xl rounded-br-2xl rounded-tr-none rounded-bl-none space-y-3" x-data="{ confirmingUserDeletion: false }">
                        ...
                        <button type="button" 
                                ...
                                class="inline-flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-black text-white font-sans text-xs font-bold transition-colors rounded-tl-lg cursor-pointer">
                            <img src="{{ asset('images/icons/bin.png') }}" alt="Hapus" class="w-4 h-4 object-contain">
