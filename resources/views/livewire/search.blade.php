    ...
    @if (strlen($query) >= 2)
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full mt-4">
            <div class="flex items-center gap-2 text-xs sm:text-sm font-sans uppercase tracking-[0.15em] border-b border-[#2F3AFF]/10 pb-4 mb-6">
                ...
                <span class="text-[#2F3AFF] font-bold">SEARCH</span>
                <span class="text-[#2F3AFF]/40">/</span>
        ...
        {{-- ============================================================ --}}
        {{-- SECTION "HASIL KARYA" — FULL WIDTH, TIDAK dibatasi max-w-7xl --}}
        {{-- ============================================================ --}}
        <section class="space-y-6 w-full my-4">
            ...
            @if ($works->isNotEmpty())
                <div class="rimesa-container rimesa-grid items-stretch">
            ...
            @else
                ...
                <div class="relative w-full max-w-4xl mx-auto my-6 sm:my-10 px-4">
