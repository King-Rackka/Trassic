        ...
        <div class="max-w-7xl mx-auto px-6 sm:px-12">
            ...
            <form wire:submit.prevent="save" class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                        ...
                        <div class="relative w-[280px] sm:w-[320px] aspect-square bg-[#FFD6F6] border-2 border-[#FC00BB] mb-6 flex items-center justify-center overflow-hidden">
                            ...
                            @else
                                <label class="cursor-pointer flex flex-col items-center justify-center w-full h-full text-gray-400 hover:text-[#FC00BB] transition p-4">
                                    ...
                                    <span class="font-sans text-[11px] font-bold tracking-wider text-center">PILIH FOTO UTAMA</span>
                                    <input type="file"
                                        wire:key="main-upload-{{ count($images) }}"
                                        wire:model="images"
                                        multiple
                                        class="hidden"
                                        accept="image/*">
                        ...
                        <div class="w-full flex flex-wrap gap-3 items-center justify-start">
                            ...
                            @if (count($images) < 10)
                                <label class="w-16 h-16 sm:w-20 sm:h-20 bg-[#FFD6F6]/60 border-2 border-[#FC00BB] flex items-center justify-center cursor-pointer hover:bg-[#FFD6F6] transition shrink-0">
                                    ...
                                    <input type="file"
                                        wire:key="add-upload-{{ count($images) }}"
                                        wire:model="images"
                                        multiple
                                        class="hidden"
                                        accept="image/*">
                ...
                <div class="w-full space-y-6">
                    ...
                    {{-- SECTION 1: UTAMA --}}
                    <div class="space-y-4">
                        <h2 class="font-display text-2xl sm:text-3xl text-[#2F3AFF] font-normal">Utama</h2>

                        {{-- JUDUL --}}
                        <div>
                            <label class="block font-sans text-xs text-[#2F3AFF] font-bold tracking-wider mb-1">JUDUL</label>
                            <div class="relative">
                                <input type="text" 
                        ...
                        <div>
                            <label class="block font-sans text-xs text-[#2F3AFF] font-bold tracking-wider mb-1">DESKRIPSI</label>
                            <textarea wire:model="description" 
                                    rows="4" 
                                    placeholder="Masukkan penjelasan lengkap mengenai karya Anda" 
                        ...
                        <div class="flex items-center justify-between pt-2"
                            ...
                            <span class="font-sans text-xs text-[#2F3AFF] font-bold tracking-wider">KOMENTAR</span>
                            
                            <div class="flex items-center gap-3">
                                {{-- Teks Status ON / OFF --}}
                                <span class="font-sans text-xs font-bold tracking-wider min-w-[28px] text-right select-none transition-colors"
                            ...
                            <div class="space-y-4 pt-2 relative">
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                        ...
                                        placeholder="Masukkan jenis material sampah utama" 
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                        ...
                                        placeholder="Masukkan sumber sampah" 
                                        class="w-full bg-[#F8F8F8] border-2 border-[#FC00BB] rounded-tl-2xl rounded-br-2xl rounded-tr-none rounded-bl-none px-4 py-2.5 text-sm text-[#2F3AFF] placeholder-gray-400 focus:outline-none">
                                </div>

                                {{-- TOTAL BERAT SAMPAH --}}
                                <div>
                                    <label class="block font-sans text-xs text-[#2F3AFF] font-bold tracking-wider mb-1">
                                        ...
                                        @for ($m = 0; $m < 4; $m++)
                                            <div class="relative flex items-center">
                                                ...
                                                <input type="text" 
                                                    ...
                                                    placeholder="Contoh: Lilin, Pewarna Makanan, Benang Wol, Kain Perca" 
